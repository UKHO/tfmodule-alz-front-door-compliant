...
resource "azurerm_cdn_frontdoor_rule" "this" {
  ...
  actions {
    ...
    dynamic "request_header_action" {
      for_each = each.value.actions.request_header_actions != null ? each.value.actions.request_header_actions : []
      content {
    ...
    dynamic "response_header_action" {
      for_each = each.value.actions.response_header_actions != null ? each.value.actions.response_header_actions : []
      content {
